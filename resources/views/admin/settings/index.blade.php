...
<div class="mb-6 flex justify-between items-center">
    <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage settings in the system.</p>
    </div>
                ...
                <tr>
                    <td colspan="2" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <span class="block">No settings found in the database.</span>
                        </div>
                    </td>
                </tr>
                @endforelse
...
@if(isset($settings) && method_exists($settings, 'links'))
